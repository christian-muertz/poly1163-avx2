...
VPBROADCASTQ 800(%rdx), %ymm0                 
VPBROADCASTQ 832(%rdx), %ymm1                 
VPBROADCASTQ 864(%rdx), %ymm2                 
...
VMOVDQU 168(%rdi),%ymm1                              
VINSERTI128 $1,182(%rdi),%ymm1,%ymm1             
VMOVDQU 196(%rdi),%ymm4                        
VINSERTI128 $1,210(%rdi),%ymm4,%ymm4             
